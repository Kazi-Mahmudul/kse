...
-- ── Bachelor To-Let demo data (roadmap step 18) ─────────────────────────────
-- Twenty realistic student-housing listings around the major campus cities.
-- Mix of room types, availability, verification, and posting ages so the
-- hub, detail, saved, and admin queues all have interesting content.

insert into public.opportunities (
  id, type, title, organization_name, summary, description,
  location, city, area,
  room_type, gender_preference,
  rent_amount, rent_currency,
  total_rooms, available_rooms, floor, bachelor_friendly, utilities_included,
  available_from,
  landlord_phone, whatsapp, contact_email,
  listing_status, image_urls,
  status, verified, published_at, created_at, updated_at,
  source_name
) values
  -- 1. Verified single room, KUET side — strong anchor for the hub
  ('77777777-7777-7777-7777-777777777701', 'tolet',
   'Single room near KUET Gate 2 (messing facilities)',
   'Mr. Rezaul Karim',
   'Bright south-facing single room, 8 min walk from KUET main gate, messing attached.',
   'Single occupancy room on the second floor of a quiet mess house. Common kitchen and dining shared with two other tenants. Wi-Fi included in rent. Water and electricity separate (shared meter, split monthly). Prefer non-smoker.',
   'Opposite KUET Gate 2, Fulbarigate', 'Khulna', 'Fulbarigate',
   'single', 'male_only',
   3500, 'BDT',
   4, 1, 2, true, false,
   '2026-10-01',
   '+880 1711-223344', '8801711223344', null,
   'available', array['https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=800'],
   'published', true, now() - interval '1 day', now() - interval '2 day', now() - interval '1 day',
   'student_submission'),

  -- 2. Shared room, girls-only, very close to KUET girls' hostel
  ('77777777-7777-7777-7777-777777777702', 'tolet',
   'Two-bed shared room — girls only, Daulatpur',
   'Mrs. Nazma Akhter',
   'Furnished shared room for two female students near KUET ladies gate.',
   'Spacious shared room with two single beds, individual wardrobes and study desks. Common bathroom shared with two other rooms. Mess meals available on request (₹1500 extra/month).',
   'Daulatpur, near Ladies Gate', 'Khulna', 'Daulatpur',
   'shared', 'female_only',
   2800, 'BDT',
   3, 1, 1, true, true,
   '2026-09-15',
   '+880 1911-556677', '8801911556677', 'nazma.mess@example.com',
   'available', array['https://images.unsplash.com/photo-1631679706909-1844bbd07221?w=800'],
   'published', true, now() - interval '3 day', now() - interval '4 day', now() - interval '3 day',
   'student_submission'),

  -- 3. Sublet for 3 months (vacation period)
  ('77777777-7777-7777-7777-777777777703', 'tolet',
   'Sublet — Sonadanga, 3 months only (vacation)',
   'Rahim Hasan',
   'Full sublet of my single room while I am on internship in Dhaka.',
   'I am interning in Dhaka from October to December 2026 and subletting my furnished single room. Includes bed, table, almirah and ceiling fan. Bachelor friendly. No cooking in room (shared kitchen on ground floor).',
   'Sonadanga Abashik, Block B', 'Khulna', 'Sonadanga',
   'sublet', 'any',
   3000, 'BDT',
   1, 1, 3, true, false,
   '2026-10-05',
   '+880 1611-998877', '8801611998877', 'rahim.hasan@example.com',
   'available', array['https://images.unsplash.com/photo-1555854877-bab0e564b8d5?w=800'],
   'published', false, now() - interval '5 day', now() - interval '6 day', now() - interval '5 day',
   'student_submission'),

  -- 4. Mess sublet, attached messing
  ('77777777-7777-7777-7777-777777777704', 'tolet',
   'Mess sublet with 3 meals — Khulna Medical area',
   'Khulna Mess House',
   'Bed in a 3-bed mess room with 3 meals/day, near Khulna Medical College.',
   'Mess-style accommodation: bed in a shared 3-bed room, three meals included (breakfast + lunch + dinner), Wi-Fi, hot water. Ideal for medical students. Bathrooms shared. Strictly non-smoking.',
   'KDA Avenue, Khulna', 'Khulna', 'KDA Avenue',
   'mess_sublet', 'any',
   5500, 'BDT',
   3, 2, 2, true, true,
   '2026-09-20',
   '+880 1811-334455', null, 'khulnamess@example.com',
   'available', array['https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=800'],
   'published', true, now() - interval '2 day', now() - interval '3 day', now() - interval '2 day',
   'student_submission'),

  -- 5. Studio near KUET (verified)
  ('77777777-7777-7777-7777-777777777705', 'tolet',
   'Studio apartment — BIDC Road, bachelor friendly',
   'Md. Shahab Uddin',
   'Independent studio with attached bath, kitchenette and balcony.',
   'Brand-new studio (≈280 sqft) on the third floor with attached western bath, kitchenette, balcony and wardrobe. Independent electric meter. No messing (kitchen only). Bachelor friendly.',
   'BIDC Road, Moylapota', 'Khulna', 'Moylapota',
   'studio', 'any',
   7500, 'BDT',
   1, 1, 3, true, false,
   '2026-10-10',
   '+880 1711-778899', '8801711778899', 'shahab@example.com',
   'available', array['https://images.unsplash.com/photo-1502672023488-70e25813eb80?w=800'],
   'published', true, now() - interval '1 day', now() - interval '1 day', now() - interval '1 day',
   'student_submission'),

  -- 6. Almost full — 1 of 5 beds left
  ('77777777-7777-7777-7777-777777777706', 'tolet',
   'Hostel-style shared room — 4 beds free → 1 left',
   'Raja Mess',
   'Renovated mess room 5 min from KUET — only 1 bed left for the spring semester.',
   '5-bed shared room on the first floor. Beds are individual cubicles with privacy curtains, study lamps and storage. Two common bathrooms and a large dining area. Gas/water included in rent.',
   'Fulbarigate, Lane 3', 'Khulna', 'Fulbarigate',
   'shared', 'male_only',
   2500, 'BDT',
   1, 1, 1, true, true,
   '2026-10-01',
   '+880 1911-223344', '8801911223344', null,
   'almost_full', array['https://images.unsplash.com/photo-1540518614846-7eded433c457?w=800'],
   'published', false, now() - interval '6 day', now() - interval '8 day', now() - interval '6 day',
   'student_submission'),

  -- 7. Host family room, Jessore city
  ('77777777-7777-7777-7777-777777777707', 'tolet',
   'Host family room — Jessore Cantonment area',
   'The Rahman Family',
   'Live with a local family in a quiet Jessore neighbourhood, two meals included.',
   'Furnished single room with a local host family. Two meals per day included (breakfast + dinner). Shared family bathroom. Wi-Fi available. Best for students who want a quieter, family environment.',
   'Chitrapole Lane, Jessore', 'Jessore', 'Chitrapole',
   'family', 'any',
   4500, 'BDT',
   2, 1, 1, false, true,
   '2026-10-15',
   '+880 1711-445566', null, 'rahman.hostfamily@example.com',
   'available', array['https://images.unsplash.com/photo-1554995207-c18c203602cb?w=800'],
   'published', true, now() - interval '4 day', now() - interval '5 day', now() - interval '4 day',
   'student_submission'),

  -- 8. Single room Khulna, no bachelor (owner prefers families)
  ('77777777-7777-7777-7777-777777777708', 'tolet',
   'Family-preferred single room, Nirala',
   'Mr. Abu Taher',
   'Quiet single room in a family building — preference for non-bachelor tenants.',
   'Single room on the second floor of a family-owned building. Bathroom attached. Not bachelor-friendly (family preference). Vegetarian cooking in room only.',
   'Nirala, near Khulna Bypass', 'Khulna', 'Nirala',
   'single', 'any',
   3200, 'BDT',
   2, 1, 2, false, false,
   '2026-11-01',
   '+880 1711-556622', '8801711556622', null,
   'available', array['https://images.unsplash.com/photo-1540518614846-7eded433c457?w=800'],
   'published', false, now() - interval '2 day', now() - interval '3 day', now() - interval '2 day',
   'student_submission'),

  -- 9. Premium studio, Dhaka — for cross-campus students
  ('77777777-7777-7777-7777-777777777709', 'tolet',
   'Premium studio near North South University',
   'Greenway Properties',
   'Furnished studio with attached bath and kitchen — ready to move in.',
   'Fully furnished studio in a 6-storey apartment. AC, geyser, lift, security guard 24/7. Maintenance included. Bachelor friendly. 6-month minimum lease.',
   'Bashundhara R/A, Dhaka', 'Dhaka', 'Bashundhara',
   'studio', 'any',
   14000, 'BDT',
   1, 1, 5, true, true,
   '2026-10-05',
   '+880 1711-001122', '8801711001122', 'greenway@example.com',
   'available', array['https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=800'],
   'published', true, now() - interval '1 day', now() - interval '2 day', now() - interval '1 day',
   'student_submission'),

  -- 10. Girls-only, Jessore (private university area)
  ('77777777-7777-7777-7777-77777777770a', 'tolet',
   'Girls-only 2-bed room, Jessore University gate',
   'Mrs. Anwara Begum',
   'Safe and quiet two-bed shared room in a residential building, 4 min walk from Jessore University gate.',
   'Two-bed shared room with attached western bath. Common kitchen and dining. Owner family lives downstairs — strict curfew by 10pm. Wi-Fi included.',
   'Jessore University Road', 'Jessore', 'Jessore University',
   'shared', 'female_only',
   3000, 'BDT',
   4, 1, 1, true, false,
   '2026-10-12',
   '+880 1911-667788', null, 'anwara.mess@example.com',
   'available', array['https://images.unsplash.com/photo-1631679706909-1844bbd07221?w=800'],
   'published', false, now() - interval '3 day', now() - interval '4 day', now() - interval '3 day',
   'student_submission'),

  -- 11. Available shared room, full capacity (status='full' even though published)
  ('77777777-7777-7777-7777-77777777770b', 'tolet',
   'Boys mess near Khulna Polytechnic — currently full',
   'Polytechnic Boys Mess',
   'Spacious 4-bed boys mess with attached messing, currently full but on a waiting list.',
   '4-bed shared room with attached messing (3 meals). 2 common bathrooms. Currently full — students can join a short waiting list for the next opening.',
   'Polashpole, Khulna', 'Khulna', 'Polashpole',
   'shared', 'male_only',
   4800, 'BDT',
   4, 0, 1, true, true,
   '2026-09-25',
   '+880 1711-665544', '8801711665544', null,
   'full', array['https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=800'],
   'published', true, now() - interval '10 day', now() - interval '14 day', now() - interval '10 day',
   'student_submission'),

  -- 12. Single, Dhaka — students only (verified)
  ('77777777-7777-7777-7777-77777777770c', 'tolet',
   'Single room — Mohammadpur (Dhaka), student only',
   'Mr. Liton Khan',
   'Quiet single room in Mohammadpur with attached bath, students preferred.',
   'Single room in a 3-storey residential building. Attached western bath, separate meter, shared kitchen. Owner prefers students. Bachelor friendly. Two-month security deposit.',
   'Town Hall, Mohammadpur', 'Dhaka', 'Mohammadpur',
   'single', 'any',
   5500, 'BDT',
   2, 1, 3, true, false,
   '2026-10-08',
   '+880 1711-778866', '8801711778866', null,
   'available', array['https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=800'],
   'published', true, now() - interval '2 day', now() - interval '3 day', now() - interval '2 day',
   'student_submission'),

  -- 13. Pending review (just submitted by student, not yet approved)
  ('77777777-7777-7777-7777-77777777770d', 'tolet',
   'Affordable single room — Daulatpur Bypass',
   'Sadia Rahman',
   'Newly furnished single room with attached bath, 12 min from KUET gate 1.',
   'Just listed. Single room on the ground floor of a small mess building. Attached western bath, separate entrance, common dining.',
   'Daulatpur Bypass, Khulna', 'Khulna', 'Daulatpur',
   'single', 'female_only',
   3800, 'BDT',
   3, 1, 0, true, false,
   '2026-11-01',
   '+880 1911-009900', '8801911009900', 'sadia.r@example.com',
   'available', array[]::text[],
   'pending_review', false, null, now() - interval '6 hour', now() - interval '6 hour',
   'student_submission'),

  -- 14. Available, Rajshahi University
  ('77777777-7777-7777-7777-77777777770e', 'tolet',
   'Boys mess near Rajshahi University gate 3',
   'Rajshahi Mess',
   'Renovated boys mess 4 min from RU gate 3, 3 meals a day.',
   'Shared 3-bed room with attached messing. Three meals/day included. Two common bathrooms. Wi-Fi included. Strictly non-smoking.',
   'Talaimari, Rajshahi', 'Rajshahi', 'Talaimari',
   'shared', 'male_only',
   4200, 'BDT',
   3, 2, 1, true, true,
   '2026-10-20',
   '+880 1711-778811', null, 'rajshahimess@example.com',
   'available', array['https://images.unsplash.com/photo-1555854877-bab0e564b8d5?w=800'],
   'published', false, now() - interval '4 day', now() - interval '5 day', now() - interval '4 day',
   'student_submission'),

  -- 15. Sublet — Chattogram
  ('77777777-7777-7777-7777-77777777770f', 'tolet',
   'Sublet for 6 months — Khulshi, Chattogram',
   'Muntaha Chowdhury',
   'Furnished single room, 6-month sublet while I finish my training.',
   'Fully furnished single room in a family apartment. Bed, study desk, wardrobe, ceiling fan. Shared kitchen and bath. Owner lives on premises.',
   'Khulshi, Chattogram', 'Chattogram', 'Khulshi',
   'sublet', 'female_only',
   5500, 'BDT',
   1, 1, 4, true, false,
   '2026-11-15',
   '+880 1811-554433', '8801811554433', null,
   'available', array['https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=800'],
   'published', false, now() - interval '1 day', now() - interval '2 day', now() - interval '1 day',
   'student_submission'),

  -- 16. Almost full, Khulna
  ('77777777-7777-7777-7777-777777777710', 'tolet',
   'Twin sharing boys mess — 1 of 6 left',
   'Bismillah Boys Mess',
   'Boys mess with 6-bed twin-share rooms, only 1 spot left.',
   'Twin sharing arrangement (2 students per room, 3 rooms total). Attached messing, hot water, Wi-Fi. Walking distance to KUET.',
   'Fulbarigate, Khulna', 'Khulna', 'Fulbarigate',
   'shared', 'male_only',
   3000, 'BDT',
   6, 1, 1, true, true,
   '2026-10-01',
   '+880 1711-334422', '8801711334422', null,
   'almost_full', array['https://images.unsplash.com/photo-1540518614846-7eded433c457?w=800'],
   'published', false, now() - interval '7 day', now() - interval '9 day', now() - interval '7 day',
   'student_submission'),

  -- 17. Studio, Sylhet (verified)
  ('77777777-7777-7777-7777-777777777711', 'tolet',
   'Studio with kitchen — Shahjalal University area',
   'Mr. Nazrul Islam',
   'Independent studio with kitchenette near SUST, bachelor friendly.',
   'Self-contained studio (≈220 sqft) with attached western bath, kitchenette (gas stove + sink), and wardrobe. Independent meter. 5 min rickshaw to Shahjalal University gate.',
   'Akhalia, Sylhet', 'Sylhet', 'Akhalia',
   'studio', 'any',
   6000, 'BDT',
   1, 1, 2, true, false,
   '2026-10-18',
   '+880 1711-909090', '8801711909090', 'nazrul.studio@example.com',
   'available', array['https://images.unsplash.com/photo-1502672023488-70e25813eb80?w=800'],
   'published', true, now() - interval '3 day', now() - interval '4 day', now() - interval '3 day',
   'student_submission'),

  -- 18. Host family, Barishal
  ('77777777-7777-7777-7777-777777777712', 'tolet',
   'Host family — Barishal city',
   'The Hasan Family',
   'Stay with a local Barishal family, two meals/day, safe environment.',
   'Furnished single room in a host family home. Two meals/day (lunch + dinner). Shared family bathroom. Quiet residential street.',
   'Sadar Road, Barishal', 'Barishal', 'Sadar Road',
   'family', 'any',
   3500, 'BDT',
   2, 1, 1, false, true,
   '2026-11-01',
   '+880 1711-223355', null, 'hasan.family@example.com',
   'available', array['https://images.unsplash.com/photo-1554995207-c18c203602cb?w=800'],
   'published', false, now() - interval '5 day', now() - interval '6 day', now() - interval '5 day',
   'student_submission'),

  -- 19. Available mess sublet
  ('77777777-7777-7777-7777-777777777713', 'tolet',
   'Mess sublet — KUET ladies gate, 2 meals',
   'KUET Ladies Mess',
   'Ladies-only mess sublet, 2 meals/day, 3 min from KUET ladies gate.',
   'Bed in a 3-bed room. Two meals included (breakfast + dinner). Wi-Fi and laundry service extra. Strict ladies-only.',
   'Near KUET Ladies Gate', 'Khulna', 'KUET Ladies Gate',
   'mess_sublet', 'female_only',
   4500, 'BDT',
   3, 2, 1, true, true,
   '2026-10-08',
   '+880 1711-882211', '8801711882211', null,
   'available', array['https://images.unsplash.com/photo-1631679706909-1844bbd07221?w=800'],
   'published', false, now() - interval '2 day', now() - interval '3 day', now() - interval '2 day',
   'student_submission'),

  -- 20. Almost full, single room, Rangpur
  ('77777777-7777-7777-7777-777777777714', 'tolet',
   'Single room — Rangpur Cadet College area',
   'Mr. Shahin Alam',
   'Newly painted single room with attached bath, only 1 of 2 left.',
   'Single room on the first floor, attached western bath, balcony. Independent electric meter. Bachelor friendly. Walking distance to local coaching centres.',
   'Jahaj Company More, Rangpur', 'Rangpur', 'Jahaj Company More',
   'single', 'any',
   3000, 'BDT',
   2, 1, 1, true, false,
   '2026-10-25',
   '+880 1711-447700', '8801711447700', null,
   'almost_full', array['https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=800'],
   'published', false, now() - interval '4 day', now() - interval '5 day', now() - interval '4 day',
   'student_submission')
on conflict (id) do nothing;
