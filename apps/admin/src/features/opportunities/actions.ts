...
function parseOpportunityForm(formData: FormData):
  ...
  const parsed = opportunityFormSchema.safeParse({
    ...
    stipend_amount: formData.get('stipend_amount'),
    stipend_currency: formData.get('stipend_currency'),
