 ...
 *
 * Bengali copy per `03._community_kse_onboarding/screen.png`. Hero photo is
 * `community.jpg` (cropped from the design screen.png). Skip pill shown
 * top-right. Tapping "Start" finishes onboarding: sets
