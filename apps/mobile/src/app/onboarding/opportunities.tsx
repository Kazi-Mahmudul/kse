 ...
 *
 * Bengali copy per `02._opportunities_kse_onboarding/screen.png`. Hero photo
 * is `opportunities.jpg` (cropped from the design screen.png). Skip pill
 * shown top-right; CTA label "Next" advances to /onboarding/community.
 */
